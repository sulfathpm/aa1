    ...
    <?php
            ...
            if(isset($_POST['buy-dress'])){
                ...
                if($_SESSION["USER_ID"]==null){
                    ...
                    $total_price = $dress['BASE_PRICE'] * $QUANTITY;  // Calculate total price
                    ...
                    $sql="INSERT INTO orders( USER_ID, DRESS_ID, STATUSES, SSIZE,QUANTITY, TOTAL_PRICE, ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) VALUES ('$_SESSION[USER_ID]','$dress_id','PENDING','$_SESSION[SIZE]',$QUANTITY,'$total_price','$estimate_date','$actual_date')";
                ...
                if($_SESSION["USER_ID"]==null){
                    ...
                    //$actual_date = date('Y-m-d', strtotime($current_date . ' + 14 days'));
                    //Now lets place order
                    $sql="INSERT INTO orders( USER_ID, DRESS_ID, STATUSES, SSIZE,QUANTITY, TOTAL_PRICE) VALUES ('$_SESSION[USER_ID]','$dress_id','CART','$_SESSION[SIZE]',$QUANTITY,'$total_price')";
                    $data=mysqli_query($dbcon,$sql);
                    if($data){
                        $sql="SELECT * FROM orders WHERE USER_ID='$_SESSION[USER_ID]' AND DRESS_ID='$_SESSION[DRESS_ID]'";
                        $data2=mysqli_query($dbcon,$sql);
