...
if (isset($_POST['order_customize'])) {
    ...
    if ($_SESSION["DRESS_ID"] == $dress_id) {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, STATUSES, SSIZE, TOTAL_PRICE, ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', 'PENDING', '$sizes', '$totalcost', '$estimate_date', '$actual_date')";
    } else {
...
if (isset($_POST['save_customize'])) {
    ...
    // Insert data into database
       ...
       if ($_SESSION["DRESS_ID"] == $dress_id) {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, STATUSES, SSIZE, TOTAL_PRICE, ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', 'CART', '$sizes', '$totalcost', '$estimate_date', '$actual_date')";
    } else {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, FABRIC_ID, STATUSES, SSIZE, TOTAL_PRICE, ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$fabric_id', 'CART', '$sizes', '$totalcost', '$estimate_date', '$actual_date')";
    }
